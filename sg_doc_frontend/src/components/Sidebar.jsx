...
//   const { selectedCompany, logout, user } = useAuth()
...
//         {/* Active Company Card */}
//         {selectedCompany && (
//           <div className={`bg-gradient-to-br ${selectedCompany.color} rounded-xl px-4 pt-3 pb-3 shadow-md`}>

//             {/* Company label + name */}
//             <p className="text-white/60 text-xs mb-0.5">Active Company</p>
...
//             {/* Logged in as */}
//             <p className="text-white/50 text-xs mb-2.5 truncate">
//               👤 {user?.name || 'User'}
//             </p>
...
//               className="w-full flex items-center gap-2 text-white/80 hover:text-white text-xs font-medium py-1.5 px-2 rounded-lg hover:bg-white/15 transition mb-1.5 cursor-pointer"
//             >
...
//               className="w-full flex items-center gap-2 text-red-300 hover:text-red-100 text-xs font-medium py-1.5 px-2 rounded-lg hover:bg-white/15 transition cursor-pointer"
//             >
//               <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
