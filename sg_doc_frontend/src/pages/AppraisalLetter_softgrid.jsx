...
//   const pf         = withPF ? Math.round((basic + da) * (Number(pfRate) || 0) / 100) : 0
//   const pfEmr      = withPF ? Math.round((basic + da) * (Number(pfEmrRate) || 0) / 100) : 0
...
//       // Fetch current monthly gross from offer_letters table
//       let curMonthly = ''
//       try {
...
//         curMonthly: curMonthly || data.current_salary || data.monthly_salary || prev.curMonthly,
//       }))
//     } catch {
