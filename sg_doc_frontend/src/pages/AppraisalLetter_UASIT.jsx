...
import { openAppraisalPDF } from '../components/AppraisalletterpreviewUASIT'
...
// ─── Salary Calculation (Monthly input, same as SoftGrid) ─────────────────
...
// ─── Component ────────────────────────────────────────────────────────────
export default function SalaryAppraisalPage_UASIT() {
  ...
  // Save appraisal record to backend (best-effort)
        ...
        <div className="max-w-3xl space-y-6">
          ...
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-8 shadow-xl">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                <label className="text-sm text-blue-400">New Monthly Gross (₹)</label>
                <input
                  type="number"
                  name="newMonthly"
                  ...
                  className={inp + " text-blue-400 font-bold"}
                />
                {nw.monthly > 0 && (
                  <p className="text-xs text-blue-600 mt-1">Annual: ₹ {fmtNum(nw.gross)}</p>
                )}
              </div>
            </div>
                    ...
                    {ROWS.map((r, i) => {
                      ...
                      return (
                        <tr key={i} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                          ...
                          <td className="px-4 py-2 text-right text-xs text-blue-400">
