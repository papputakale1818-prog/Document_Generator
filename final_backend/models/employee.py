...
class Employee(Base):
    ...
    # ── Relieving Letter ──────────────────────────────────────────────────────
    relieving_letter = relationship("RelievingLetterSoftgrid", back_populates="employee", uselist=False)

    # ── Resignation Acceptance ────────────────────────────────────────────────
    resignation_acceptance = relationship("ResignationAcceptanceSoftgrid", back_populates="employee", uselist=False)